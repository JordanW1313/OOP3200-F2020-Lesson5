...
static void BuildGameObjects(std::vector<GameObject*>& game_objects, const int num = 1)
{
	for (auto count = 0; count < num; count++)
	{
		...
		std::cin >> id;
		Vector2D point;
		std::cout << "Enter the gameObject Positions (x, y): ";
		std::cin >> point;
		std::cout << "\n--------------------------------------------------------------" << std::endl;
		std::cout << "You Entered " << id << " for the gameObject's ID";
...
static void CompareGameObjects(GameObject* object1, GameObject* object2)
{
	...
	std::cout << "Distance between first gameObject and second gameObject is: " << Vector2D::Distance(object1->GetPosition(), object2->GetPosition()) << std::endl;
	std::cout << "--------------------------------------------------------------\n" << std::endl;
